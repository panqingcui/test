...
public class ReadMessages {
    ...
    public void doIt() throws Exception {
        ...
        try {
            ...
            SerialModemGateway gateway = new SerialModemGateway("modem.com3", "COM3", 9600, null, null);
            ...
            this.srv.getKeyManager().registerKey("+15242424550",
                    new AESKey(new SecretKeySpec("0011223344556677".getBytes(), "AES")));
            // this.srv.getKeyManager().registerKey("+15242424550", new AESKey(new

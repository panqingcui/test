...
/**
 * A Sample Application built to showcase how to use the default
 * ConcurrentCompositeConfiguration registered with {@link DynamicPropertyFactory} and
 * automatic registration with JMX <p> To run this sample application, add the following
 * jars to your classpath: <ul> <li>archaius-core-xxx.jar (latest release/snapshot of
 * archaius-core) <li>commons-configuration-1.8.jar <li>commons-lang-2.6.jar
...
public class SampleApplicationWithDefaultConfiguration {
 /*   static {
        ...
        System.setProperty("com.netflix.config.samples.SampleApp.SampleBean.sensitiveBeanData",
                "value from system property");
    }

    public static void main(String[] args) {
        new SampleApplication();
        ConcurrentCompositeConfiguration myConfiguration = (ConcurrentCompositeConfiguration) DynamicPropertyFactory
        ...
        // property "com.netflix.config.samples.SampleApp.SampleBean.numSeeds" is from
        // sampleapp.properites
        // property "com.netflix.config.samples.SampleApp.SampleBean.name" is from

...
//
// /**
// * 手工加载驱动<br> 正常情况下程序会自动加载驱动，故通常不需要人工加载<br> 每重复加载一次，会把端口重复注册，CommPortIdentifier.getPortIdentifiers()获取的端口就会重复
// */
...
// + portId.getPortType() + portId.getCurrentOwner());
// } else {
...
// try {
// // sPort = (SerialPort) commDriver.getCommPort("COM3", CommPortIdentifier.PORT_SERIAL);

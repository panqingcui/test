...
// */
// public class test {
// public static boolean updatePassword(String username, String password, String
/// newpassword) {
// return connection(conn -> statement(conn, "select id, password from user where username
/// = ?", stmt -> {
// stmt.setString(1, username);
// return resultSet(stmt, rs -> {
// if (rs.next()) {
...
// }
//
// public static <T> T statement(Connection conn, String sql, StatementCallback<T>
...
// }
//
// public static <T> T resultSet(PreparedStatement stmt, ResultSetCallback<T> callback)
/// throws SQLException {
// ResultSet rs = null;
// T result = null;
// try {

...
/*
 * MIB file parser intended ONLY for OBJECT-TYPE name -> OID conversion For example, converting: "wwwServiceDescription"
 * to: "1.3.6.1.2.1.65.1.1.1.1.2" IMPORTS are ignored and parse() order of MIBs does not matter, provided all MIB files
 * required to lookup a given name have been parsed prior to calling getOID(name).
 */

...
public class Official1 {
    ...
    private static Log log = LogFactory.getLog(Official1.class);
     ...
     * @return
     */
    public static JSONObject httpRequest(String requestUrl, String requestMethod, SendUser user) {
     ...
     * @throws IOException
     */
    public static String sendMessage(String token, String requestMethod, SendUser user) {

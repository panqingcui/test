 ...
 */
public class ActiveMqjClient {
    // 日志
    private static final Log logger = LogFactory.getLog(ActiveMqjClient.class);
    ...
    public static void main(String[] args) {
        String jmxUrl = "service:jmx:rmi:///jndi/rmi://192.168.2.205:11099/jmxrmi";
        try {
            ...
            logger.error(e);
            // if(e.getClass().getSimpleName().equals(anObject)){}

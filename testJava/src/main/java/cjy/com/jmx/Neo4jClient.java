...
public class Neo4jClient {
    // 日志
    private static final Log logger = LogFactory.getLog(Neo4jClient.class);
    ...
    public static void main(String[] args) {
        String jmxUrl = "service:jmx:rmi:///jndi/rmi://192.168.2.186:12099/jmxrmi";
        try {
            ...
            ObjectName on = new ObjectName("org.neo4j:instance=kernel#0,name=Primitive count");
